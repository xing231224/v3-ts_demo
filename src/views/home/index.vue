 ...
 * @LastEditTime: 2022-02-15 10:09:41
...
const { postVerification, register, getAllInfo } = loginApi
const { proxy } = getCurrentInstance() as any; // 获取挂载全局的变量 和 方法
const myTheme = theme()
let routerList = router.options.routes.filter((item) => item.name)
// pinia 获取 数据
